...
public class PullToRefreshView extends LinearLayout {
	...
	private boolean footerRefresh=true;//允许下拉
	private boolean headerRefresh=true;//允许上拉
	
	public boolean isFooterRefresh() {
		return footerRefresh;
	}

	public void setFooterRefresh(boolean footerRefresh) {
	...
	public void setHeaderRefresh(boolean headerRefresh) {
		this.headerRefresh = headerRefresh;
	}
	...
	public boolean onInterceptTouchEvent(MotionEvent e) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			int deltaY = y - mLastMotionY;//触摸大于个像素才开始监听
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		if(mPullState == PULL_DOWN_STATE&&!isHeaderRefresh())return true;
		if(mPullState == PULL_UP_STATE&&!isFooterRefresh())return true;
	...
	private void headerPrepareToRefresh(int deltaY) {
		...
		if (newTopMargin >= 0 && mHeaderState != RELEASE_TO_REFRESH) {
			...
			//mLastUpdateTime=PreferencYoukeUtils.getString("", null);
			if(mLastUpdateTime!=null)mLastUpdateTime="最近更新:"+mLastUpdateTime;
